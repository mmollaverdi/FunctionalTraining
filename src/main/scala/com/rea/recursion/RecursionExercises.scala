...
object RecursionExercises1 {
  ...
  def add(a: Int, b: Int): Int = {
    def addAcc(remaining: Int, acc: Int): Int = if (remaining == 0) acc else addAcc(minusOne(remaining), plusOne(acc))
    addAcc(a, b)
  }
